...
def menu(file_path):
    ...
    while True:
        ...
        while parent_subnet:
            ...
            back = input('View child subnet details (1)\tBack to parent subnets (2): ')
            # input checking
            ...
            if back == '2':
                ...
                # print out vulnerabilities of subnet chosen
                print_vulnerable_ips_in_subnet(child_subnet)
                # prompt user to export as excel or not
